...
nrfutil settings generate --family NRF52840 --application ../../PRJ/ses/Output/Release/Exe/BeepBase.hex --application-version 1 --bootloader-version 1 --bl-settings-version 1 ../../BTLDR/ses/Output/Release_skip_CRC/Exe/BL_settings.hex;
