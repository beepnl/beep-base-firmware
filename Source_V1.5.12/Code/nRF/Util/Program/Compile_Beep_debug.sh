...
mergehex --merge ../../BTLDR/ses/Output/Debug/Exe/beep_bootloader.hex ../../BTLDR/ses/Output/Debug/Exe/APP_SD.hex --output ../../BTLDR/ses/Output/Debug/Exe/APP_SD_BL.hex;
...
echo ""; sleep 1;
nrfutil pkg generate --hw-version 52 --application-version 1 --application ../../PRJ/ses/Output/Debug/Exe/BeepBase.hex --sd-req 0xB6 --key-file ../../Key/private.key Beepbase_app.zip;
echo ""; sleep 1;
nrfutil pkg generate --application ../../BTLDR/ses/Output/Debug/Exe/Beepbase.hex --application-version 1  --bootloader ../../BTLDR/ses/Output/Debug/Exe/beep_bootloader.hex --bootloader-version 1 --softdevice ../../nRF5_SDK_15.3/components/softdevice/s140/hex/s140_nrf52_6.1.1_softdevice.hex --hw-version 52 --sd-req 0xB6 --sd-id 0xB6 --key-file ../../Key/private.key Beepbase_sd_boot_app_DEBUG.zip
