...
#define	BEEP_TYPES_H
	...
	/// TODO: test firmware updates
	#define FIRMWARE_MAJOR              1
    #define FIRMWARE_MINOR              6
    #define FIRMWARE_SUB                1
    ...
    typedef enum
    {
        ...
        APP_FLASH_MX_ERASE_A,           // Erase the MX flash chip
        APP_FLASH_MX_ERASE_B,
        APP_FLASH_MX_ERASE_C,
        APP_FLASH_FATFS_ERASE,           // File system erase.
        ...
        APP_FLASH_READ_OFFSET,
        APP_FLASH_WRITE_OFFSET,
        APP_FLASH_FILL_LOG_A,
        APP_FLASH_FILL_LOG_B,
        APP_FLASH_STOP_FILL,
	...
	typedef enum
	{
        ...
        READ_SQ_MIN_STATE           = 19,	// 0x13 R/W		Current state: IO input and state machine state. Enable/Disable shutdown mode.
        WRITE_SQ_MIN_STATE          = READ_SQ_MIN_STATE | CID_WRITE,	// 0x93 R/W		Current state: IO input and state machine state. Enable/Disable shutdown mode.	    
        ...
        READ_LOG_OFFSET             = 40,   // 0x28
        WRITE_LOG_OFFSET            = READ_LOG_OFFSET | CID_WRITE,  // 0xA8
