...
void bme_app_while(void)
{
    ...
    switch(bme.state)
    {
        ...
        case BME_START:
        {
            ...
            else if(!i2cApp_getEnabled(I2C_BME280))
            {
                i2cApp_Enable(true, I2C_BME280);
            }
            else
            {
        ...
        case BME_STOP:
            ...
            // Disable the power to the TLV Audio ADC and turn of the I2C port flag
            if(powerApp_getEnabled(PWR_BME280))
			{
				powerApp_Enable(false, BME280);
			} else if (i2cApp_getEnabled(I2C_BME280))
            {
                i2cApp_Enable(false, I2C_BME280);
            }
            else
            {
