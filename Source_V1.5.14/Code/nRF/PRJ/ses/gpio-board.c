...
void GpioMcuInit( void )
{
	...
	// I2C extern: BME280
	nrf_gpio_cfg_output_state(SCL_EXT,				1);
    nrf_gpio_cfg_output_state(SDA_EXT,				1);
...
{
	// I2C extern: BME280
	nrf_gpio_cfg_input(SCL_EXT,				GPIO_PIN_CNF_PULL_Pullup);
    nrf_gpio_cfg_input(SDA_EXT,				GPIO_PIN_CNF_PULL_Pullup);
...
{
	return nrf_gpio_pin_out_read(TPS_PWR_ENABLE);
}
